    ...
    <div className="value-section   padding-top mx-auto py-12">
      ...
      <div className="flex row mx-md-n5  justify-content-center">
        <div className="col-12 col-md-6 col-lg-4 ">
          <div className='w-100 m-2 card bg-light '>
            <div className="icon-wrapper ">
              <img className=" border border-success rounded-circle p-3" src="/Images/Mask group 1.png" alt="Mask group 2" />
            </div>
        ...
        <div className="col-12 col-md-6 col-lg-4 ">
          <div></div>
          <div className="icon-wrapper">
            <img className=" border border-success rounded-circle p-3" src="/Images/Mask group 2.png" alt="Mask group 2" />
          </div>
          <div className="content">
        ...
        <div className="col-12 col-md-6 col-lg-4 ">
          <div className="icon-wrapper">
            <img className=" border border-success rounded-circle p-3" src="/Images/Mask group 3.png" alt="Mask group 1" />
          </div>
          <div className="content">
