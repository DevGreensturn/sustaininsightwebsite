      ...
      <div className='row'>
        <div className='col-lg-6'>
          <div>
            ...
            <Image src="/Images/about-7.png" width={580} height={400} alt='loading' className={`${styles.image_leftside} px-4 mb-4`} />
          </div>
        </div>
        
        <div className={`${styles.choose_rightcontent} col-lg-6 text-white mt-4`}>
          <div className={`${styles.choose_rightcontent_p} `}>
            <Image src="/Images/about-9.png" width={30} height={30} alt='arrow' className='arrow-logo' />
